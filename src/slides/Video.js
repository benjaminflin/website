  ...
  return (
    <div className={container}>
      ...
      <p ref={descriptionRef} className={description}>
        This video is of me playing over my composition, &ldquo;Banality of
        Evil,&rdquo; at Shine Cafe in Sacramento, CA. If you want to get
        together to play or hire me for a gig, just contact me at my{" "}
        <a href="mailto:ben@flin.org" className={link}>
          phone
        </a>{" "}
        or{" "}
        <a href="tel:(530)-400-1959" className={link}>
          email.
        </a>
      </p>
